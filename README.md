...
1. Download the `Car-Data.json` file from this repository.
2. Go to your Flowise instance and click **Load / Import**.
3. Select the downloaded file to see the full workflow.To review the internal logic, please import the car-data.json file into your Flowise instance.
